...
Ziel dieser Arbeit war es zu zeigen, dass eine zuverlässige Gebärdenspracherkennung auch unter schwierigen Bedingungen möglich ist – selbst dann, wenn die Daten stark ungleich verteilt sind oder sich einzelne Gebärden visuell stark ähneln. Unser \textit{SignNet}-Framework spielte dabei eine zentrale Rolle: Durch die gezielte Kombination eines Transformer-Modells mit einem physikalisch orientierten Feature-Engineering konnten wir die Erkennungsrate im Verlauf des Projekts deutlich steigern.

In der ersten Transformer-Phase (Phase~6) lag die Genauigkeit noch bei 53{,}94\,\%. Mit der Integration kinematischer und geometrischer Merkmale in Phase~9 erreichten wir schließlich eine beeindruckende Genauigkeit von \textbf{73{,}15\,\%} auf dem Validierungsdatensatz. Besonders hervorzuheben ist die Top-5-Genauigkeit von \textbf{91{,}76\,\%}. Sie zeigt, dass das System in über neun von zehn Fällen die korrekte Gebärde zumindest unter den fünf wahrscheinlichsten Kandidaten identifiziert. Diese Ergebnisse bestätigen, dass der Ansatz mit den \textit{EnhancedLandmarkFeatures} ein entscheidender Schritt war, um die dynamischen Eigenschaften der Gebärden präzise abzubilden.
...
Unsere Fehleranalyse war hier ein echter Augenöffner: Bei optischen Minimalpaaren wie \texttt{ABEND} und \texttt{NACHT}, die sich visuell extrem ähnlich sind, stösst das Skelett-Modell an seine Grenzen. Hier müssten wir in Zukunft die Mimik und das Mundbild (Face-Mesh) noch viel stärker gewichten, um diese feinen, aber entscheidenden Unterschiede greifbar zu machen.
