...
Ein weiterer Erfolg war der \textbf{Umgang mit der extremen Klassenimbalance} (593:1 Verhältnis zwischen häufigster und seltenster Klasse). Die Implementierung von Balanced Softmax Loss in Kombination mit gezieltem Oversampling für seltene Klassen führte zu einer Gesamtverbesserung von 11,4\,\% (61,75\,\% auf 73,15\,\% Accuracy). Besonders beeindruckend war die 18,2\,\%-Verbesserung bei Klassen mit weniger als 100 Samples.
...
Die Transformer-Architektur mit 256 Hidden Units, 4 Layern und 8 Attention Heads ($\sim$4M Parameter) erwies sich als guter Kompromiss zwischen Performance und Overfitting-Risiko. Das ursprüngliche, grössere Modell (512h/6L/8heads, $\sim$21M Parameter) zeigte einen 16\,\%-Train/Validation-Gap.
