...
\section{Zielsetzung}
Ziel dieser Arbeit ist die Entwicklung, Implementierung und Evaluation des \textit{SignNet}-Systems zur Erkennung von Gebärdensprach-Glossen. Im Fokus steht die Frage, ob ein hierarchisches Klassifikationskonzept gegenüber einem monolithischen Modell bessere Erkennungsraten liefert.
...
\begin{itemize}
    ...
    \item \textbf{Hierarchische Expertenmodelle}: Entwicklung spezialisierter Submodelle für systematisch verwechselbare Gruppen (z.\,B. Richtungsangaben, wetterbezogene Begriffe).
