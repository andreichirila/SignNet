\documentclass[12pt,a4paper,german,titlepage,oneside]{scrbook}
...
\newcommand{\worktitle}{SignNet}
% Here we can define a subtitle for the work. If there is no subtitle let this variable empty.
\newcommand{\worksubtitle}{Erkennung von Gebärdensprach-Glossen \\ mit Computer Vision und Deep Learning}
...
\newcommand{\theauthor}{Andrei Chirilă \\ Roman Schläpfer}
...
\newcommand{\workdatemonth}{Dezember}
\newcommand{\supervisorslabel}{Unter der Aufssicht von}
