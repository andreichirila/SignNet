...
INPUT_MODEL = Path(r"..\Models\improved_model.pth")
# Output: GUI-compatible model
OUTPUT_MODEL = Path(r"..\Models\improved_model_converted.pth")
...
if isinstance(checkpoint, torch.nn.Module):
    ...
    try:
        ...
        from SignNetPlusModel import PhoenixDatasetImproved
        ...
        dataset = PhoenixDatasetImproved(train_files, augment=False)
